		...
		<div class="lp-header-inner">
			...
			<div class="lp-header-actions">
				...
				<button type="button" class="lp-mobile-menu-btn" id="lpMobileMenuBtn" aria-label="Apri menu" aria-expanded="false">
					<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
				</button>
			</div>
		</div>
	</header>
	...
	<section class="lp-hero">
		...
		<div class="lp-hero-inner">
			<div class="lp-hero-content" data-reveal>
				...
				<h1 class="lp-hero-title"><span class="sr-only">Timeline SalernoHub - </span>Dai forma al tempo con timeline eleganti e professionali</h1>
				...
				<div class="lp-hero-cta">
					<a href="editor.php" class="lp-btn lp-btn-lg lp-btn-primary">
						...
						<svg aria-hidden="true" viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
					</a>
			...
			<div class="lp-steps">
				<article class="lp-step" data-reveal>
					...
					<div class="lp-step-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="32" height="32" stroke="currentColor" fill="none" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
					</div>
				...
				<article class="lp-step" data-reveal data-reveal-delay="120">
					...
					<div class="lp-step-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="32" height="32" stroke="currentColor" fill="none" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>
					</div>
				...
				<article class="lp-step" data-reveal data-reveal-delay="240">
					...
					<div class="lp-step-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="32" height="32" stroke="currentColor" fill="none" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>
					</div>
			...
			<div class="lp-features-grid">
				<div class="lp-feature" data-reveal>
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
					</div>
				...
				<div class="lp-feature" data-reveal data-reveal-delay="80">
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
					</div>
				...
				<div class="lp-feature" data-reveal data-reveal-delay="160">
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
					</div>
				...
				<div class="lp-feature" data-reveal data-reveal-delay="240">
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
					</div>
				...
				<div class="lp-feature" data-reveal data-reveal-delay="320">
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
					</div>
				...
				<div class="lp-feature" data-reveal data-reveal-delay="400">
					<div class="lp-feature-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
					</div>
			...
			<div class="lp-examples-grid">
				<article class="lp-example" data-reveal>
					<div class="lp-example-icon">
						<svg aria-hidden="true" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
